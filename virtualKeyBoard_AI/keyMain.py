...
def run_keyboard():
    ...
    cv2.namedWindow("Keyboard", cv2.WINDOW_NORMAL)  # Create window with normal flag
    cv2.setWindowProperty("Keyboard", cv2.WND_PROP_TOPMOST, 1)  # Set window to be always on top
